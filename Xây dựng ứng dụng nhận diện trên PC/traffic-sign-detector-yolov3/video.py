...
video = cv2.VideoCapture('./inputs/videos/test2.mp4')
...
with open('./data/yolo.names') as f:
...
network = cv2.dnn.readNetFromDarknet('./cfg/yolov3-43c-86000-max-steps.cfg',
                                     './weights/yolov3-43c-86000-max-steps_best.weights')
...
while True:
    ...
    if len(results) > 0:
        ...
        for i in results.flatten():
            ...
            cv2.imshow('Object Detection in videos', frame)  
